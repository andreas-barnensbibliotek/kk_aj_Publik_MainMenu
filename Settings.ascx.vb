...
''' 
''' Because the control inherits from kk_aj_Publik_MainMenuSettingsBase you have access to any custom properties
''' defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
''' </summary>
''' -----------------------------------------------------------------------------
Public Class Settings
    Inherits kk_aj_Publik_MainMenuSettingsBase
